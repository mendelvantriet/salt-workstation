...
xfconf-query -c xfce4-panel -p /plugins/plugin-3 -t string -s tasklist -n
xfconf-query -c xfce4-panel -p /plugins/plugin-3/show-handle -t bool -s false -n
xfconf-query -c xfce4-panel -p /plugins/plugin-4 -t string -s separator -n
xfconf-query -c xfce4-panel -p /plugins/plugin-4/expand -t bool -s true -n
xfconf-query -c xfce4-panel -p /plugins/plugin-4/style -t int -s 0 -n
xfconf-query -c xfce4-panel -p /plugins/plugin-5 -t string -s xfce4-clipman-plugin -n
